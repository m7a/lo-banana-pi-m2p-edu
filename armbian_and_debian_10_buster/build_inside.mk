...
local_extract_root_dev:
	...
	dpkg-deb -x "$(ma_devpre)"/linux-*-root-*bananapim2plus*.deb \
...
local_debootstrap_sub:
	...
	debootstrap --no-check-gpg --arch=armhf --foreign buster \
...
local_boot:
	...
	rm "$(ma_chrfs)/var/tmp/build/debs"/linux-*-root-*bananapim2p*.deb \
